...
package com.saadahmedev.baseboilerplate.util;
...
import com.saadahmedev.baseboilerplate.BuildConfig;
...
public class SessionManager {
    ...
    private SessionManager(@NonNull Context context) {
        sharedPreferences = context.getSharedPreferences("CONST_SESSION_MANAGER" + BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
